...
Verbesserung.
Bei Betrachtung des Baumes fällt auf, dass gleich zu Beginn des Baumes, wenn "space" relativ häufig vorkommt, "screen", "graphic", "simple" und "disk" aber selten vorkommen die Zielklasse wahrscheinlich 2 "Raumfahrt" ist. Dies deckt sich mit unseren Erwartungen zu Beginn des Projektes.
