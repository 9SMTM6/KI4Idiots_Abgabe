...
Daher wollen wir desweiteren die insgesamte Häufigkeit des Wortes im vergleich zu allen Wörtern ($N_{\text{wort}} / N$) bestimmen und diese beiden Größen verknüpfen.
...
Desweiteren ist zu beachten, dass die Texte auch gut über zwanzig Jahre alt sind und damit sind die Muster der Beiträge wahrscheinlich nicht auf Muster mit aktuellen Daten zu übertragen.
